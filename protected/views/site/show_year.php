			...
			FROM newyear
                    ...
                    if (!empty($newyear_id)) {
                        ...
                        <ul id="horizon" style="list-style: none;">
                            &#9899
                            เกณฑ์ตัวชี้วัด : 
                            <li><a style="text-decoration: none;" href="<?php echo Yii::app()->request->baseUrl;  ?>/index.php?r=site/show&template_type_id=<?= $template_type_id; ?>&department_id=1&template_type_level_id=<?= $template_type_level_id ?>&newyear_id=<?= $newyear_id ?>&newyear_name=<?= $newyear_name ?> ">ดูทั้งหมด</a></li>
                            <li><a style="text-decoration: none;" href="<?php echo Yii::app()->request->baseUrl;  ?>/index.php?r=site/show&template_type_id=<?= $template_type_id; ?>&department_id=1&template_type_level_id=<?= $template_type_level_id ?>&newyear_id=<?= $newyear_id ?>&newyear_name=<?= $newyear_name ?>&process='ผ่านเกณฑ์' ">ผ่านเกณฑ์</a></li>
                            <li><a style="text-decoration: none;" href="<?php echo Yii::app()->request->baseUrl;  ?>/index.php?r=site/show&template_type_id=<?= $template_type_id; ?>&department_id=1&template_type_level_id=<?= $template_type_level_id ?>&newyear_id=<?= $newyear_id ?>&newyear_name=<?= $newyear_name ?>&process='ไม่ผ่านเกณฑ์' ">ไม่ผ่านเกณฑ์</a></li>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                ...
                                <th>ชื่อตัวชี้วัด</th>
                                <th>เป้าหมาย</th>                       
                                <th>ปี <?php echo $newyear_name; ?></th>                         
